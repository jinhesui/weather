...
namespace Jinhesui\Weather\Tests;

use GuzzleHttp\Client;
use GuzzleHttp\ClientInterface;
use GuzzleHttp\Psr7\Response;
use Mockery\Matcher\AnyArgs;
use Jinhesui\Weather\Exceptions\HttpException;
use Jinhesui\Weather\Exceptions\InvalidArgumentException;
use Jinhesui\Weather\Weather;
